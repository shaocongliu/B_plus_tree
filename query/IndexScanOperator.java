...
public class IndexScanOperator extends QueryOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    ...
    try {
      ...
      numOfIndexPages = (float) this.transaction.getNumIndexPages(this.tableName, this.columnName);
      numOfRecords = (float) this.transaction.getNumRecords(this.tableName);
    } catch (DatabaseException de) {
      throw new QueryPlanException(de);
    }
    return (int) Math.ceil(rf*(numOfRecords+numOfIndexPages));
  }
